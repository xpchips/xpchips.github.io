...
-- Chat script
scriptContext:AddCoreScript(81451333, screenGui, "CoreScripts/ChatScript")	
...
if game.CoreGui.Version >= 3 then
	...
	if game.CoreGui.Version >= 7 then
		print("Add bp manager")
		scriptContext:AddCoreScript(81452683,Backpack,"CoreScripts/BackpackScripts/BackpackManager")
		print("bp manager added")
	end
	
	-- Backpack Gear (handles all backpack gear tab stuff)
	game:GetService("ScriptContext"):AddCoreScript(81452684,Backpack,"CoreScripts/BackpackScripts/BackpackGear")
