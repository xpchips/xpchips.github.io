...
if UserSettings and LoadLibrary then
	...
	local function clearTableEntry(obj, tableInfo)
		if tableInfo.MainObjectSmall then
			print("tableInfo.MainObjectSmall.Name =",tableInfo.MainObjectSmall.Name)
			print("tableInfo.MainObjectSmall.className =",tableInfo.MainObjectSmall.className)
			print("tableInfo.MainObjectSmall.Parent =",tableInfo.MainObjectSmall.Parent)
			tableInfo.MainObjectSmall.Parent = nil
			tableInfo.MainObjectSmall:Remove()
