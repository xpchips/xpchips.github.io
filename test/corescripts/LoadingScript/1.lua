...
function makeDefaultLoadingScreen()
	...
	local startSize = UDim2.new(0,20,0,40)

	local midPos = UDim2.new(0.5,-5,1,-100)
	local midSize =  UDim2.new(0,10,0,20)

	local endSize = startSize
	local endPos = UDim2.new(0.5,160,1,-100)
