...
local useNewTools = false -- for separated stamper
...
if not toolsArray then -- no one has made build tools yet, we get to!
	...
	if not useNewTools then
		...
		table.insert(buildToolIds,129688806) -- PartSelectionTool
		table.insert(buildToolIds,129688805) -- DeleteTool
		table.insert(buildToolIds,129688807) -- CloneTool
		table.insert(buildToolIds,129688809) -- RotateTool
		table.insert(buildToolIds,129688808) -- RecentPartTool
		table.insert(buildToolIds,129688811) -- ConfigTool
		table.insert(buildToolIds,129688812) -- WiringTool
		table.insert(buildToolIds,58921588)  -- ClassicTool
	end
	
	-- Lets gather the owner tools
	--if string.find(baseUrl,"gametest") then
	table.insert(ownerToolIds, 129632230)
	--[[elseif string.find(baseUrl,"sitetest") then
		table.insert(ownerToolIds, 129632490)
	else
