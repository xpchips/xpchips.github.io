...
if game.CoreGui.Version >= 3 then
	...
	if game.CoreGui.Version >= 7 then
		scriptContext:AddCoreScript(81427757,Backpack,"CoreScripts/BackpackScripts/BackpackManager")
	end
	
	-- Backpack Gear (handles all backpack gear tab stuff)
	game:GetService("ScriptContext"):AddCoreScript(81427755,Backpack,"CoreScripts/BackpackScripts/BackpackGear")
