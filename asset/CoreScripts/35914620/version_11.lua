...
function makeYRelative()
	...
	if buildTools.Frame.Position.X.Scale == -0.1 then
		buildTools.Frame.Position = UDim2.new(0,-buildTools.Frame.AbsoluteSize.X,buildTools.Frame.Position.Y.Scale,0)
	end
