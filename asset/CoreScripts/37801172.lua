...
if game.CoreGui.Version >= 2 then
	-- New Player List
	dofile("rbxasset://coreguiscripts\\PlayerlistScript.lua")
	-- Popup Script
	dofile("rbxasset://coreguiscripts\\PopupScript.lua")
	-- Friend Notification Script (probably can use this script to expand out to other notifications)
	dofile("rbxasset://coreguiscripts\\NotificationScript.lua")
end
