...
if UserSettings then
	local createSettingsDialog = function()
		...
		settingsButton = script.Parent.BottomLeftControl.SettingsButton
	...
	delay(0, function()
		createSettingsDialog().Parent = script.Parent
		script.Parent.BottomLeftControl.SettingsButton.Active = true
...
local function createHelpDialog()
	waitForChild(script.Parent, "TopLeftControl")
	waitForChild(script.Parent.TopLeftControl, "Help")
...
local createReportAbuseDialog = function()
	...
	waitForChild(script.Parent, "BottomRightControl")
	waitForChild(script.Parent.BottomRightControl, "ReportAbuse")
	local reportAbuseButton = script.Parent.BottomRightControl.ReportAbuse
...
delay(0, 
	function()
		...
		helpDialog.Parent = script.Parent
		
		script.Parent.TopLeftControl.Help.MouseButton1Click:connect(function() helpDialog.Visible = true end)
		script.Parent.TopLeftControl.Help.Active = true
	end)
...
if isSaveDialogSupported then
	delay(0, 
		function()
			...
			saveDialogs.Parent = script.Parent
...
local isChatBarSupported = pcall(function() local var = game.CoreGui.Version end)
if isChatBarSupported then
	delay(0,
		function()
