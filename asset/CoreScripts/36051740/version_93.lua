...
while script.Parent:FindFirstChild("PlayerName") == nil do
	tryCount = tryCount + 1
	if tryCount > 10 then
...
local player = game.Players:FindFirstChild(script.Parent.PlayerName.Value).Character
local backpack = game.Players:FindFirstChild(script.Parent.PlayerName.Value).Backpack
