...
function reset(subset)
	...
	if subset.Name == "AddDeleteTools" then
		for i = 1, #buttons do
			...
			if buttons[i].Name == "CloneObject" then buttons[i].Image = localAssetBase .. "CloneButton.png"-- "http://www.roblox.com/asset/?id=34763469"
			elseif buttons[i].Name == "DeleteObject" then buttons[i].Image = localAssetBase .. "DeleteButton.png"--"http://www.roblox.com/asset/?id=34763507"
			elseif buttons[i].Name == "InsertObject" then buttons[i].Image = localAssetBase .. "InsertButton.png"--[["http://www.roblox.com/asset/?id=34763542"]] end
		end
	...
	elseif subset.Name == "MiscTools" then
		for i = 1, #buttons do
			buttons[i].Selected = false
			if buttons[i].Name == "PropertyTool" then buttons[i].Image = localAssetBase .. "PropertyButton.png"--[["http://www.roblox.com/asset/?id=34763628"]] end
		end
	...
	elseif subset.Name == "PhysicalTools" then
		for i = 1, #buttons do
			buttons[i].Selected = false
			if buttons[i].Name == "GroupMove" then buttons[i].Image = localAssetBase .. "GroupMoveButton.png"--"http://www.roblox.com/asset/?id=34763745"
			elseif buttons[i].Name == "PartMove" then buttons[i].Image = localAssetBase .."PartMoveButton.png"--"http://www.roblox.com/asset/?id=34763762"
			elseif buttons[i].Name == "ScaleObject" then buttons[i].Image = localAssetBase .. "ScaleButton.png" --[["http://www.roblox.com/asset/?id=34763793"]] end
		end
	...
	elseif subset.Name == "PropertyTools" then
		for i = 1, #buttons do
			buttons[i].Selected = false
			if buttons[i].Name == "InputSelector" then buttons[i].Image = localAssetBase .. "SurfaceButton.png" --"http://www.roblox.com/asset/?id=34763945"
			elseif buttons[i].Name == "MaterialSelector" then buttons[i].Image = localAssetBase .. "MaterialButton.png" --"http://www.roblox.com/asset/?id=34763907"
			elseif buttons[i].Name == "PaintTool" then buttons[i].Image = localAssetBase .. "PaintButton.png" --[["http://www.roblox.com/asset/?id=34763886"]] end
		end
	end
...
function setButtonStateActive(Object, Name)
	...
	if Name == "BuildInsert" then Object.Image = localAssetBase .."InsertButton_dn.png"--[[ "http://www.roblox.com/asset/?id=34849257"]] Object.Selected = true
	elseif Name == "BuildDelete" then Object.Image = localAssetBase .. "DeleteButton_dn.png" --[["http://www.roblox.com/asset/?id=34849301"]] Object.Selected = true
	elseif Name == "BuildCloneTest" then Object.Image = localAssetBase .. "CloneButton_dn.png" --[["http://www.roblox.com/asset/?id=34849314"]] Object.Selected = true
	elseif Name == "BuildConfiguration" then Object.Image = localAssetBase .. "PropertyButton_dn.png" --[["http://www.roblox.com/asset/?id=34859934"]] Object.Selected = true
	elseif Name == "BuildDragger" then Object.Image = localAssetBase .. "PartMoveButton_dn.png" --[["http://www.roblox.com/asset/?id=34859980"]] Object.Selected = true
	elseif Name == "BuildGroupDragger" then Object.Image = localAssetBase .. "GroupMoveButton_dn.png" --[["http://www.roblox.com/asset/?id=34859955"]] Object.Selected = true
	elseif Name == "BuildResize" then Object.Image = localAssetBase .. "ScaleButton_dn.png" --[["http://www.roblox.com/asset/?id=34860007"]] Object.Selected = true
	elseif Name == "BuildSurfaceTest" then Object.Image = localAssetBase .. "SurfaceButton_dn.png" --[["http://www.roblox.com/asset/?id=34860057"]] Object.Selected = true
	elseif Name == "BuildMaterialTest" then Object.Image = localAssetBase .. "MaterialButton_dn.png" --[["http://www.roblox.com/asset/?id=34860076"]] Object.Selected = true
	elseif Name == "BuildColorTester" then Object.Image = localAssetBase .. "PaintButton_dn.png" --[["http://www.roblox.com/asset/?id=34860098"]] Object.Selected = true
	end
