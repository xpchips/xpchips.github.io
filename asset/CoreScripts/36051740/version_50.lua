...
buildTools.Frame.PropertyTools.PaintTool.PaintMenu.closedState.Changed:connect(function(value)
	if value == true then
		print("deselecting paint")
		toolDeselection("BuildColorTester",buildTools.Frame.PropertyTools.PaintTool,35205409)
		buildTools.Frame.PropertyTools.PaintTool.PaintMenu.closedState.Value = false
	end
end)
