...
local productPurchaseText = "Would you like to buy the itemName assetType from assetOwner for currencyTypecurrencyAmount?"
local productPurchaseTixOnlyText = "Would you like to buy the itemName assetType from assetOwner for currencyAmount currencyType?"
