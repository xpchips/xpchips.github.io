...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<!-- ("http://rclient.cf/asset/?id=" + id); -->
    			function insertContent(id)
    			{
    				try
                	{
                    	window.external.Insert("http://rclient.cf/asset/toolbox/models/" + id);
                    }
	                catch(x)
	                {
    			...
    			function dragRBX(id)
    			{
    				try
    				{
    					event.dataTransfer.setData("Text", "http://rclient.cf/asset/toolbox/models/" + id);
    				}
	                catch(x)
	                {
  ...
  <div>
      ...
      <div class="Navigation">
        <div id="Previous">
          <a href="https://http://rclient.cf/IDE/FreeModels.aspx" id="PreviousPage" style="visibility:hidden"><span class="NavigationIndicators">&lt;&lt;</span>
          Prev</a>
        </div>
        <div id="Next">
          <a href="http://rclient.cf/IDE/FreeModels.aspx" id="NextPage">Next <span class="NavigationIndicators">&gt;&gt;</span></a>
        </div>
        <div id="Location">
      ...
      <div class="Navigation">
        <div id="Previous">
          <a href="http://rclient.cf/IDE/FreeModels.aspx" id="PreviousPage" style="visibility:hidden"><span class="NavigationIndicators">&lt;&lt;</span>
          Prev</a>
        </div>
        <div id="Next">
          <a href="http://rclient.cf/IDE/FreeModels.aspx" id="NextPage">Next <span class="NavigationIndicators">&gt;&gt;</span></a>
