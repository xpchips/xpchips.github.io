 ...
 <header class="header py-2">
    <nav class="navbar navbar-expand-lg navbar container">
      <div class="container-fluid">
		...
		<a href="http://rclient.cf/IDE/Start.aspx"><img src="http://rclient.cf/favicon.ico" height="35px" width="35px"/></a>
		<a class="navbar-brand" href="http://rclient.cf/IDE/Start.aspx">Client - Start</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto mt-3 mt-md-0">
            ...
            <li class="nav-item">
              <a class="nav-link text-black" href="#Start">Start</a>
            </li>
