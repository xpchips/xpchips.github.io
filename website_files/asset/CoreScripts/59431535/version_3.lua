-- Script Globals
local useNewBuildTools = true

local buildDeleteID = 36738185
local buildStamperID = 55028088
local buildGroupDraggerID = 0--36334760
local buildConfigID = 0--55027987
...
while tryCount < 20 game.Players.LocalPlayer.Name == "Player" and game.Players.LocalPlayer.userId == 0 do
	wait(0.3)
	tryCount = tryCount + 1
end
