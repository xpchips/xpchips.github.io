...
function repositionLoadout()
	local xOffset = (screen.AbsoluteSize.X - currentLoadout.AbsoluteSize.X) /2
	local yOffset = (screen.AbsoluteSize.Y - currentLoadout.AbsoluteSize.X) /2
	currentLoadout.Position = UDim2.new(0,xOffset,currentLoadout.Position.Y.Scale,currentLoadout.Position.Y.Offset)
end
...
print("At end of backpackresizer")
