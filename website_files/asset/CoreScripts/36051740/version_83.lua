...
local player = game.Players:FindFirstChild(script.PlayerName.Value).Character
local backpack = game.Players:FindFirstChild(script.PlayerName.Value).Backpack
