...
buildTools.Frame.PropertyTools.MaterialSelector.MaterialMenu.CloseButton.ClosedState.Changed:connect(function(value)
	if value == true then
		print("deselecting material")
		toolDeselection("BuildMaterialTest",buildTools.Frame.PropertyTools.MaterialSelector,35223828)
...
buildTools.Frame.PropertyTools.PaintTool.PaintMenu.CloseButton.ClosedState.Changed:connect(function(value)
	if value == true then
		print("deselecting paint")
		toolDeselection("BuildColorTester",buildTools.Frame.PropertyTools.PaintTool,35205409)
...
buildTools.Frame.PropertyTools.InputSelector.SurfaceMenu.CloseButton.ClosedState.Changed:connect(function(value)
	if value == true then
		print("deselecting surface")
		toolDeselection("BuildSurfaceTest",buildTools.Frame.PropertyTools.InputSelector,35226945)
