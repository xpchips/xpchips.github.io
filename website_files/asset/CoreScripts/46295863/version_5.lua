	...
	local createSettingsDialog = function()
		...
		if supportVideoCapture then
			...
			syncVideoCaptureSetting = function()
				if script.Parent:FindFirstChild("BottomRightControl") and script.Parent.BottomRightControl:FindFirstChild("RecordToggle") then
...
delay(0, 
	function()
		...
		script.Parent.TopLeftControl.Help.MouseButton1Click:connect(
			function() 
