...
t.CreateDropDownMenu = function(items, onSelect, forRoblox)
	...
	local scrollUpMouseCount = 0
	local scrollDownMouseCount = 0
	...
	if useScrollButtons then
		...
		scrollUpButton.MouseButton1Click:connect(
			function()
				scrollUpMouseCount = scrollUpMouseCount + 1
			end)
		...
		scrollUpButton.MouseButton1Down:connect(
			function()
				...
				scrollUp()
				local val = scrollUpMouseCount
				wait(0.5)
				while val == scrollUpMouseCount do
					scrollUp()
					wait(0.1)
				end				
			end)
		...
		scrollDownButton.MouseButton1Click:connect(
			function()
				scrollDownMouseCount = scrollDownMouseCount + 1
			end)
		...
		scrollDownButton.MouseButton1Down:connect(
			function()
				...
				scrollDown()
				local val = scrollDownMouseCount
				wait(0.5)
				while val == scrollDownMouseCount do
					scrollDown()
					wait(0.1)
				end				
			end)	
