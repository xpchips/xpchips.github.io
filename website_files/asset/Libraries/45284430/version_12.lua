...
t.CreateSlider = function(steps,width,position)
	...
	function setSliderPos(newAbsPosX)
		...
		local relativePosX = (newAbsPosX - bar.AbsolutePosition.X) / bar.AbsoluteSize.X
		...
		sliderPosition.Value = (relativePosX * steps) + 1
	end
	...
	areaSoak.MouseLeave:connect(function() cancelSlide() end)
	
	slider.MouseButton1Down:connect(function()
		areaSoak.Visible = true
		if areaSoakMouseMoveCon then areaSoakMouseMoveCon:disconnect() end
		areaSoakMouseMoveCon = areaSoak.MouseMoved:connect(function(x,y) setSliderPos(x) end)
		areaSoak.MouseButton1Up:connect(function() cancelSlide() end)
	end)
	
	slider.MouseButton1Up:connect(function() cancelSlide() end)
	
	sliderPosition.Changed:connect(function(prop)
		local relativePosX = (sliderPosition.Value - 1) / steps
		if relativePosX ~= slider.Position.X.Scale then
			slider.Position = UDim2.new(relativePosX,0,slider.Position.Y.Scale,slider.Position.Y.Offset)
		end
	end)
