--rbxsig%DYN+jQoixOPQlMvB5DBt6rqWpThDxEvLEqSE+3RUQZv/bHPZ3ErYomcdL13zcvmg1B3M707m84OV4sUPdStlMPCEd9ZYI27vYsez0dhAhoZLiCLCpUWGW4P5k1tOZ5/bt4NJdkwvZgPSDBvaNqV0cfAMn99b4e4tIxJ+QvR7fc4=%
...
function gameIsLoaded()
	if Game.ReplicatedFirst:GetLoadingFinished() then
		removeLoadingScreen()
	else
...
Game.ReplicatedFirst.LoadingFinished:connect(function()
	removeLoadingScreen()
end)
if Game.ReplicatedFirst:GetLoadingFinished() then
	removeLoadingScreen()
