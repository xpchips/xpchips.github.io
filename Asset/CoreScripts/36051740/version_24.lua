...
function setButtonStateActive(Object, Name)
	...
	elseif Name == "BuildDragger" then Object.Image = "http://www.roblox.com/asset/?id=34859955"
	elseif Name == "BuildGroupDragger" then Object.Image = "http://www.roblox.com/asset/?id=34859980"
...
function setButtonStateDeactive(Object, Name)
	...
	elseif Name == "BuildDragger" then Object.Image = "http://www.roblox.com/asset/?id=34763745" Object.Selected = false
	elseif Name == "BuildGroupDragger" then Object.Image = "http://www.roblox.com/asset/?id=34763762" Object.Selected = false
...
function toolSelection(Name,Object,id)
	...
	if equipped then
		...
		if hasTool:IsA("HopperBin") then hasTool.Active = false print("Active == false") end
		hasTool.Parent = nil
		hasTool:remove()
