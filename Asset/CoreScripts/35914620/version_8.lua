...
function makeXRelative()
	...
	if screen.Frame.Position.X.Scale == -buildTools.Frame.Size.X.Scale then
		screen.Frame.Position = UDim2.new(0,-screen.Frame.AbsoluteSize.X,screen.Frame.Position.Y.Scale,0)
	end
